...
export const PayPalBtn = ({orderNumber, setOrderNumber}) => {
        ...
        return {
            ...
            onAuthorize: (data, actions) => {
                return actions.payment.execute().then(function (res) {
                    ...
                    dispatch(completeOrder(user.token, orderNumber, setOrderNumber, navigate)) // call my Payment Success action
                });
            }
        }
    }
    ...
    return (
        <div id="paypal-button" style={{marginTop: '1.5rem'}}></div>
    )
}